...
private class TableGenOverriddenFieldAssignmentLineMarkerProvider : LineMarkerProviderDescriptor() {
    ...
    override fun getLineMarkerInfo(element: PsiElement): LineMarkerInfo<*>? {
        ...
        val scope = parent.parentOfType<TableGenClassStatement>() ?: return null
        val fieldName = parent.fieldName
        ...
        return NavigationGutterIconBuilder.create(icon).setTooltipText("Navigate to previous value of '$fieldName'")
