...
abstract class TableGenBinaryIntegerNodeMixin : StubBasedPsiElementBase<TableGenBinaryIntegerValueNodeStub>,
    TableGenBinaryIntegerValueNode, PsiElement {
    ...
    ) : super(stub as TableGenBinaryIntegerValueNodeStub, stubType)
