 ...
 */
fun TableGenType.refinedBy(valueType: TableGenType): TableGenType = when (this) {
    is TableGenRecordType if valueType is TableGenRecordType && valueType.isConvertibleTo(this) == true ->
        valueType

    is TableGenListType if valueType is TableGenListType ->
        TableGenListType(elementType.refinedBy(valueType.elementType))
