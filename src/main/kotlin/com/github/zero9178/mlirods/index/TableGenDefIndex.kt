...
val ALL_RECORDS_INDEX = StubIndexKey.createIndexKey<Int, TableGenDefStatement>("ALL_RECORDS_INDEX")
...
private class TableGenAllRecordsIndex : IntStubIndexExtension<TableGenDefStatement>() {

    override fun getKey(): StubIndexKey<Int, TableGenDefStatement> {
        return ALL_RECORDS_INDEX
    }
}
