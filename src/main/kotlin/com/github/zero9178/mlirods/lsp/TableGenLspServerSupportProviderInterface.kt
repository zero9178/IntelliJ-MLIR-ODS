...
/**
 * Interface similar to [LspIntegrationProvider] but only for TableGen files.
...
interface TableGenLspServerSupportProviderInterface {
     ...
     * [clientStarter] may be used to immediately start an LSP server.
     * Longer running startup-tasks (such as downloading the server),
     * may also start the download process and later use the
     * [com.intellij.platform.lsp.api.LspClientManager] to start the LSP.
     *
