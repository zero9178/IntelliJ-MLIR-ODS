...
- A multiclass statement following another definition of the same multiclass, be it in the same file or a file included
  before, is reported as an error. A quick fix navigates to the closest such definition.
